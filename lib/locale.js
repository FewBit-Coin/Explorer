...
(exports.difficulty = "Difficulty"),
	...
	(exports.ex_search_message =
		"Search by block height, block hash, tx hash or address"),
	...
	(exports.error_description_alt =
		"An error occurred which prevented the page from loading correctly"),
	// address view
	(exports.a_title = "{1} Wallet Address Details"),
	(exports.a_description =
		"Viewing balance and transaction data from {1} address {2}"),
	...
	(exports.mn_description =
		"A listing of all masternodes known to be active on the {1} network"),
	(exports.mn_masternode_list = "Masternode List"),
	// movement view
	(exports.move_title = "{1} Coin Movements"),
	(exports.move_description =
		"A listing of larger movements where {1} or more {2} coins were sent in a single transaction"),
	// richlist view
	(exports.rl_title = "Top {1} Coin Holders"),
	(exports.rl_description =
		"A listing of the richest {1} wallet addresses and breakdown of the current coin distribution"),
	...
	(exports.net_description =
		"A listing of {1} network peers that have connected to the explorer node in the last 24 hours"),
	...
	(exports.api_description =
		"A listing of public API endpoints for retrieving {1} coin data from the network without the need for a local wallet"),
	...
	(exports.api_getmasternodelist =
		"Returns the complete list of masternodes on the network."),
	(exports.api_getmasternodecount =
	...
	(exports.claim_description =
		"Verify ownership of your {1} wallet address and set a custom display name in the explorer"),
	// orphans view
	(exports.orphan_title = "{1} Orphaned Blocks"),
	(exports.orphan_description =
		"A listing of valid blocks that have been orphaned and do not belong to the main blockchain"),
	...
	(exports.heavy_description =
		"Viewing {1} voting data and coin reward change details"),
	...
	(exports.reloadLocale = function reloadLocale(locale) {
		...
		for (var i in lsettings) {
			...
			if (i.charAt(0).search("[a-z]") !== 0)
				console.warn(
					"Settings should start with a low character: '" + i + "'"
				);
