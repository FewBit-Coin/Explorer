...
exports.shared_pages = {
	...
	page_footer: {
		...
		powered_by_text:
			"<a class='nav-link poweredby' href='https://github.com/team-exor/eiquidus' target='_blank'>eIquidus Explorer v{explorer_version}</a>",
	},
};
...
exports.loadSettings = function loadSettings() {
	...
	try {
		...
		console.error(
			"There was an error processing your settings.json file: " +
				e.message
		);
		process.exit(1);
	}
	...
	if (json_settings != null) {
		...
		if (json_settings.shared_pages.page_footer.social_links != null) {
			...
			json_settings.shared_pages.page_footer.social_links.forEach(
		...
		if (json_settings.logo != null) {
			json_settings.logo = json_settings.logo.replace(
				"/images/",
				"/img/"
			);
		}
		...
		if (json_settings.github != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					...
					json_settings.display.github == null
						? false
		...
		if (json_settings.discord != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.discord == null
						? false
		...
		if (json_settings.reddit != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.reddit == null
						? false
		...
		if (json_settings.youtube != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.youtube == null
						? false
		...
		if (json_settings.slack != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.slack == null
						? false
		...
		if (json_settings.twitter != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.twitter == null
						? false
		...
		if (json_settings.website != null) {
			...
			json_settings.shared_pages.page_footer.social_links.push({
				enabled:
					json_settings.display == null ||
					json_settings.display.website == null
						? false
			...
			json_settings.markets.enabled.forEach(function (market) {
				...
				if (
					...
					json_settings.markets_page.exchanges[market].trading_pairs =
						[
							json_settings.markets.coin +
								"/" +
								json_settings.markets.exchange,
						];
					// check if the default exchange trading pair is set
					if (
						json_settings.markets_page.default_exchange
							.trading_pair == null
					) {
						// fix parent elements to be sure there are no missing parents
						json_settings = ensure_parent_elements_exist(
		...
		if (Object.byString(json_settings, "api") != null)
			delete json_settings.api;
...
merge_settings = function (json_settings, exceptions, current_setting, path) {
	...
	if (typeof current_setting === "object" && current_setting !== null) {
		...
		if (Object.byString(exports, path) == null) {
			...
			if (
				Array.isArray(current_setting) ||
				exceptions.indexOf(path) > -1
			) {
